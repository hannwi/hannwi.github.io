...
graph LR
    ...
    style A fill:#e05555,color:#fff
    style B fill:#d47844,color:#fff
    style C fill:#d47844,color:#fff
    style D fill:#d47844,color:#fff
    style E fill:#d47844,color:#fff
```
...
graph TD
    ...
    style A fill:#3aafa9,color:#fff
    style F fill:#4a90c4,color:#fff
```
...
graph LR
    ...
    style R fill:#e05555,color:#fff
    style G fill:#45b369,color:#fff
    style RF fill:#4a90c4,color:#fff
```
...
graph TD
    ...
    style P1 fill:#e05555,color:#fff
    style P3 fill:#d4a03c,color:#fff
    style P5 fill:#45b369,color:#fff
    style STOP fill:#8395a7,color:#fff
```
